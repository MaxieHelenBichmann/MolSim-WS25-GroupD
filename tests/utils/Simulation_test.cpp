...
TYPED_TEST(CalculateFTest, calculateF_simple2_pairwise) {
    ...
    CheckpointWriterMock checkpoint_writer;
    StatsWriterMock stat_writer;
    Simulation<TypeParam> simulation(this->particles, mock, this->settings, writer, checkpoint_writer, stat_writer);
...
TYPED_TEST(CalculateThermostatTest, test_total_energy_0) {
    ...
    CheckpointWriterMock checkpoint_writer;
    StatsWriterMock stat_writer;
    Simulation<TypeParam> simulation(this->particles, force, this->settings, writer, checkpoint_writer, stat_writer);
